...
def pictureInupt(filename):
    t = image_to_tuple(filename, threshold=95, saveFile='/Users/apple/Desktop/digit ios/transfer.png')
    fileP=open('/Users/apple/Desktop/digit ios/data.txt','w')
...
def initialWeight():
    ...
    j=0
    #从txt文件中读取权值
    fileW1=open('/Users/apple/Desktop/digit ios/W1.txt','r')
    fileW2=open('/Users/apple/Desktop/digit ios/W2.txt','r')
    for item in fileW1:
        item=item.split('\t')
        for data in item:
            W1[i][j]=float(data)
...
def identify(filename):
    ...
    W1,W2=initialWeight() 
    inputVect=initialVector('/Users/apple/Desktop/digit ios/data.txt')
